...
export default function ShareVehicleSection() {
  ...
  const bgStyle = {
    ...
    backgroundPosition: isSmall ? "center right" : "center right",
    ...
    <section className="relative min-h-[400px] md:h-screen bg-white overflow-hidden my-10">
      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="max-w-7xl mx-auto px-6 md:px-16 w-full">
          <div className="relative z-10 bg-white border-2 border-[#EA3C3C] rounded-xl p-8 max-w-md shadow-sm md:mr-auto hover:shadow-2xl transition-shadow duration-300  ">
            ...
            <button className="bg-[#EA3C3C] text-white font-semibold px-5 py-2.5 rounded-lg hover:scale-105 transition-transform duration-300 ">
              Learn More
            </button>
          </div>
        </div>
